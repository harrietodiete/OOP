...
public class DayPlanner {
    ...
    */
    public boolean matchedKeyword(String keyword, String[] tokens) {
    ...
    */
    public boolean matchedKeywords(String[] keywords, String title) {
    ...
    * @param type  Used to read the user's input.
    * @param title  Used to read the user's input.
    * @param startingTime  Used to read the user's input.
    * @param endingTime  Used to read the user's input.
     * @return 
    */
    public ArrayList<Activity> searchActivities(String type, String title, Time startingTime, Time endingTime)
    {
        ArrayList<Activity>searchResults = new ArrayList<Activity>();
        ...
        {
            System.out.println("YES keywords is null");
    ...
    */
    public void readFile(File object)
    {
    ...
    * @param fileObject The file object been written to.
    */
    ...
    */
    ...
    {
        String keywords[] = null;
        int countSize = Activities.size() - counter;
        //Runs for the size of the ArrayList of activities
        for(int i = countSize; i<Activities.size(); i++)
        {
        ...
        Iterator<Map.Entry<String, ArrayList<Integer>>> n = map.entrySet().iterator(); 
        while(n.hasNext()){
            String key = n.next().getKey();
    ...
    * Activities.
    */
    public Integer [] searchMap(String [] keyword)
    {
